...
const typescriptTSESConfigArray = [
  ...
  // These rules existed in the `.eslintrc`.
  {
    name: "@amo/typescript/disabled-in-js",
...
const testingLibraryTSESConfig = {
  name: "@amo/testing-library/react/base",
  files: ["**/*.test.ts", "**/*.test.tsx"],
  plugins: {
