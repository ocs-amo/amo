      ...
      <form onSubmit={e => e.preventDefault()}>
        <VStack px="md">
          ...
          <FormControl display="flex" flexDirection={{base: 'row', md: 'column'}} gap={{base: '2xl', md: 'md'}} maxW="2xl">
            ...
            <Select w={{base: 'md', md: 'full'}} placeholder="講師を選択" items={teachers} />
          </FormControl>
          <FormControl display="flex" flexDirection={{base: 'row', md: 'column'}} gap={{base: '2xl', md: 'md'}} maxW="2xl">
          ...
          <FormControl display="flex" flexDirection={{base: 'row', md: 'column'}} gap={{base: '2xl', md: 'md'}} maxW="2xl">
            ...
            <Select w={{base: 'md', md: 'full'}} placeholder="代表を選択" items={students} />
          </FormControl>
          <FormControl display="flex" flexDirection={{base: 'row', md: 'column'}} gap={{base: '2xl', md: 'md'}} maxW="2xl">
            <Label flexGrow={1}>副代表</Label>
            <Select w={{base: 'md', md: 'full'}} placeholder="副代表を選択" items={students} />
          </FormControl>
